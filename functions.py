class Functions:
    # Scalar functions
    def abs(self): return  # TODO

    def acos(self): return

    def ago(self): return  # TODO

    def array_concat(self): return

    def array_iif(self): return

    def array_length(self): return  # TODO

    def array_slice(self): return

    def array_split(self): return

    def asin(self): return
